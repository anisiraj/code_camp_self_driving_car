...
animate ()
function save(){
    localStorage.setItem("bestBrain",JSON.stringify(besatCar.brain));
...
function animate(time){    
    ...
    carCtx.save()
    carCtx.translate(0,-besatCar.y+carCanvas.height*0.7)
    road.draw(carCtx);
    ...
    besatCar.draw(carCtx,"blue",true);
    ...
    Visualizer.drawNetwork(networkCtx,besatCar.brain);
